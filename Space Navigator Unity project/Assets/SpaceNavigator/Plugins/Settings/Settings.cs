        ...
        public static void OnGUI()
        {
            ...
            switch (Settings.Mode)
            {
                case OperationMode.Fly:
                    tx = Settings.FlyInvertTranslation.x < 0;
                    ty = Settings.FlyInvertTranslation.y < 0;
                    tz = Settings.FlyInvertTranslation.z < 0;
                    rx = Settings.FlyInvertRotation.x < 0;
                    ry = Settings.FlyInvertRotation.y < 0;
                    rz = Settings.FlyInvertRotation.z < 0;
                    break;
                case OperationMode.Orbit:
                    tx = Settings.OrbitInvertTranslation.x < 0;
                    ty = Settings.OrbitInvertTranslation.y < 0;
                    tz = Settings.OrbitInvertTranslation.z < 0;
                    rx = Settings.OrbitInvertRotation.x < 0;
                    ry = Settings.OrbitInvertRotation.y < 0;
                    rz = Settings.OrbitInvertRotation.z < 0;
                    break;
                case OperationMode.Telekinesis:
                    tx = Settings.TelekinesisInvertTranslation.x < 0;
                    ty = Settings.TelekinesisInvertTranslation.y < 0;
                    tz = Settings.TelekinesisInvertTranslation.z < 0;
                    rx = Settings.TelekinesisInvertRotation.x < 0;
                    ry = Settings.TelekinesisInvertRotation.y < 0;
                    rz = Settings.TelekinesisInvertRotation.z < 0;
                    break;
                case OperationMode.GrabMove:
                    tx = Settings.GrabMoveInvertTranslation.x < 0;
                    ty = Settings.GrabMoveInvertTranslation.y < 0;
                    tz = Settings.GrabMoveInvertTranslation.z < 0;
                    rx = Settings.GrabMoveInvertRotation.x < 0;
                    ry = Settings.GrabMoveInvertRotation.y < 0;
                    rz = Settings.GrabMoveInvertRotation.z < 0;
                    break;
                default:
